...
![](/media/spring/Quartz-Job-Scheduler란/image_3.png)
		* CronTrigger
...
![](/media/spring/Quartz-Job-Scheduler란/image_25.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_24.png)

		* TriggerLIstener
			* Trigger가 발생하거나 불발이 일어날 때나 Trigger를 완료할 때 이벤트를 받을 수 있다

![](/media/spring/Quartz-Job-Scheduler란/image_16.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_8.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_22.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_4.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_20.png)
	* **2.2 ==> stop() : SmartLifeCycle 인터페이스의 의해서 호출된다**
		* 톰켓 shutdown할 때 stop() 메서드가 호출된다
![](/media/spring/Quartz-Job-Scheduler란/image_11.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_15.png)
...
![](/media/spring/Quartz-Job-Scheduler란/image_19.png)
