...
3. 요청에 대한 HandlerMapping 처리
    ...
    2. (요청시) `RequestMappingHandlerAdapter.invokeHandlerMethod()`에서 Argument resolver를 실행한다 ([#1.2.2](https://blog.advenoh.pe.kr/spring/handler-method-argument-resolver-%EC%9D%B4%EB%9E%80/#122-supportsparameter%EB%8A%94-%EC%96%B4%EB%94%94%EC%97%90%EC%84%9C-%ED%98%B8%EC%B6%9C%EB%90%98%EB%82%98))
